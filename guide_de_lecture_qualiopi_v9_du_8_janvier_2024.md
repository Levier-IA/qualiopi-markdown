# Guide de lecture — Référentiel national qualité (Qualiopi)

**Version 9 — 8 janvier 2024**

> Référentiel mentionné à l'article L. 6316-3 du Code du travail.
...
Le prestataire a la responsabilité de démontrer qu’il respecte les exigences des indicateurs.

Les exemples de preuves ne sont pas exhaustifs, ils illustrent les documents que peut fournir le prestataire audité. La conformité repose sur l’appréciation de l’auditeur quant à la mise en œuvre des exigences et non sur la seule présence ou l’absence de l’un ou plusieurs des éléments de preuve listés.
...
NB : Le taux d'obtention de la certification doit être mis en relation avec le taux de présentation à l'examen.

L’information sur les débouchés comprend le taux d’insertion global dans l’emploi et le taux d’insertion dans le métier visé des titulaires de la certification figurant sur la fiche RNCP.
...
Nouveaux entrants : un processus d’articulation des apprentissages est formalisé pour les deux lieux de formation : en centre de formation et en entreprise.
...
CBC : mise à disposition des moyens dédiés à l’activité. Un environnement garantissant la discrétion et la confidentialité des échanges est prévu.

Le cas échéant, l’habilitation des personnes devant faire passer les tests est précisée.
...
Le prestataire présente : - la liste des membres du conseil de perfectionnement, le dernier compte-rendu et/ou procès-verbal ; - la liste des personnes dédiées à la mobilité (nationale et internationale) et les actions mises en œuvre en faveur de la mobilité ; - le nom et le contact du référent handicap et les actions qu’il met en œuvre pour accompagner les publics en situation de handicap.

**Exemples de preuves**

Nom et qualité des membres du conseil de perfectionnement (dernier compte-rendu et/ou procès-verbal, preuve de constitution en cours du conseil de perfectionnement pour le nouveau CFA) ; Nom et qualité des personnes dédiées à la mobilité (nationale et internationale) ; Nom du référent handicap et procès-verbal de sa nomination ; Missions remplies par les référents et personnels dédiés, exemples d’actions menées.
...
Participation aux instances et manifestation des partenaires, compte-rendu de rencontres, invitation à des réunions, prise de contact.
...
Lorsque la prestation échantillonnée est une prestation pour laquelle l’organisme intervient en sous-traitance : le prestataire démontre qu’il dispose d’un réseau de partenaires/experts/acteurs du champ du handicap ou que son

donneur d’ordre lui a communiqué la liste de ses partenaires mobilisables pour orienter les PSH et mettre en place des mesures spécifiques.
...
Le prestataire recueille les appréciations des parties prenantes : bénéficiaires, financeurs, équipes pédagogiques et entreprise concernées.
...
NB : Les modalités de recueil peuvent être différentes selon la partie prenante.
...
Récapitulatif des indicateurs audités dans le cadre de l’article 10 de l’arrêté du 6 juin 2019 relatif aux modalités d’audit associées au référentiel national mentionné à l’article D.6316-1-1 du code du travail.
...
*Source : Ministère du Travail, du Plein emploi et de l'Insertion, DGEFP — janvier 2024.*
